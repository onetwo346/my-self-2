...
// iPhone-Specific UI and Features
function isIPhone() {
    return /iPhone/.test(navigator.userAgent);
}

if (isIPhone()) {
    mapPlaceholder.style.display = 'block'; // Render maps on iPhone
    voiceOptions.style.display = 'inline-block'; // Render voice options on iPhone
